...
| 产物 | 说明 | 实测 |
| --- | --- | --- |
| `preview/index.html` | 单文件离线模板站 | 当前 catalog 为 50 卡片、19 徽章；本轮未运行产物质量门禁 |
...
- 31 个模板尚无官方数据验证；KMP、浮点 FFT 与组合数等需要本地对拍或
  适配验证契约。浮点 FFT 当前有随机对拍结果，但没有官方验证徽章；
  新增的两份动态开点线段树、线性递推与更新后的字符串模板尚未运行语法
  门禁，Z 函数需重跑官方数据以刷新结果；
